# KidsMonitor — Original Design Plan

This is the original greenfield design doc written before implementation started. It's kept
for historical context (why the architecture looks the way it does); it does **not** track
current status. See the git log and [README.md](README.md) for what's actually built and how
to use it.
